package com.secureclaims.notification.config;

import com.secureclaims.notification.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(c -> c.disable())
                ...
                .authorizeHttpRequests(a -> a
                        ...
                        .requestMatchers("/api/notifications/v1/admin/**").hasRole("ADMIN")
